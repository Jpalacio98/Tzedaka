...
class Sidebar(QtWidgets.QFrame):
    def __init__(self,datos):
        ...
        self.label_pie .setMinimumSize(QtCore.QSize(70, 70))
        self.label_pie.setMaximumSize(QtCore.QSize(70, 70))
...
class Menubutton(QtWidgets.QPushButton):
    def __init__(self, etiqueta,icono):
        ...
        self.icon_label2.setFixedHeight(60)
        self.icon_label2.setFixedWidth(60)
    ...
    def leaveEvent(self, event):
        self.setFixedSize(QtCore.QSize(250, 70))
